...
export const LandingPage: React.FC = () => {
  const { setCurrentView, setIsAuthModalOpen, loginAs } = useApp();
      ...
      <header className="h-18 bg-white/90 backdrop-blur-md border-b border-stone-200 sticky top-0 z-40 px-6 sm:px-12 flex items-center justify-between">
        <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setCurrentView('landing')}>
          ...
          <div>
            ...
            <p className="text-[11px] text-stone-500 font-medium">India Trade Portal for MSMEs</p>
          </div>
        </div>

        <nav className="hidden md:flex items-center space-x-8 text-xs font-semibold text-stone-600">
          <a href="#features" className="hover:text-teal-800 transition">Capabilities</a>
          <a href="#roadmap" className="hover:text-teal-800 transition">12-Step Journey</a>
          <a href="#compliance" className="hover:text-teal-800 transition">EU & US Rules</a>
          <a href="#estimator" className="hover:text-teal-800 transition">Cost Simulator</a>
        </nav>
